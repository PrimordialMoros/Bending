...
public class Vector3 extends Vector3D {
  ...
  public Vector3 min(Vector3 other) {
    return new Vector3(FastMath.min(getX(), other.getX()), FastMath.min(getY(), other.getY()), FastMath.min(getZ(), other.getZ()));
  }

  public Vector3 max(Vector3 other) {
    return new Vector3(FastMath.max(getX(), other.getX()), FastMath.max(getY(), other.getY()), FastMath.max(getZ(), other.getZ()));
  }
