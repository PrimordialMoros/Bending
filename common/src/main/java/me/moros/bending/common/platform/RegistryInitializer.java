...
public interface RegistryInitializer extends Initializer {
  ...
  default void init() {
    ...
    Registry<Key, BlockProperties> propertyRegistry = ReflectionUtil.getFieldOrThrow(clazz, "PROPERTY_REGISTRY");
    Registry<Key, BlockState> stateRegistry = ReflectionUtil.getFieldOrThrow(clazz, "STATE_REGISTRY");
    Registry<Key, Item> itemRegistry = ReflectionUtil.getFieldOrThrow(clazz, "ITEM_REGISTRY");
