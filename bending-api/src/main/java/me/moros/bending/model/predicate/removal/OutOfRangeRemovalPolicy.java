...
public final class OutOfRangeRemovalPolicy implements RemovalPolicy {
  ...
  private OutOfRangeRemovalPolicy(double range, @Nullable Vector3d origin, Supplier<Vector3d> from) {
  ...
  public static RemovalPolicy of(double range, Supplier<Vector3d> from) {
    return of(range, null, from);
  }

  public static RemovalPolicy of(double range, @Nullable Vector3d origin, Supplier<Vector3d> from) {
