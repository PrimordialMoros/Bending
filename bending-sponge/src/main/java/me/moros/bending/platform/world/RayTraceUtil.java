...
public class RayTraceUtil {
  ...
  static BlockRayTrace rayTraceBlocks(Context context, Level level, SpongeWorld world) {
  ...
  private static BlockRayTrace traverseBlocks(Level level, ClipContext context, BlockRayTrace miss, Function<BlockHitResult, BlockRayTrace> hitFactory) {
  ...
  private static @Nullable BlockRayTrace checkBlockCollision(Level world, ClipContext context, BlockPos pos, BlockRayTrace miss, Function<BlockHitResult, BlockRayTrace> hitFactory) {
  ...
  private static Function<BlockHitResult, @Nullable BlockRayTrace> hitFactory(World w) {
    return result -> {
      ...
      var b = new me.moros.bending.platform.block.Block(w, p.getX(), p.getY(), p.getZ());
